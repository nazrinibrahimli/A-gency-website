...
const LandingPage = () => {
  return (
    <div className='lg:px-[9.5rem] px-[3rem] pt-[6rem] bg-fixed bg-center bg-no-repeat bg-[url("/static/bg.jpg")]  bg-cover  h-[40rem] relative overflow-hidden '>

      <h1 className='text-center text-3xl md:text-4xl lg:text-5xl  text-[white] font-bold'>Improve the way you charge, with only <span className=' text-[white]'>one click.</span></h1>
      ...
      <div className="lg:flex lg:w-[25rem] mx-auto mt-[3rem]">
     <div className=' w-[10.5rem] font-sans bg-gray-dark  text-[white] rounded-sm mx-auto  h-[3rem] '>
