...
const LandingPage = () => {
  return (
    <div className='lg:px-[15.5rem] sm:px-[8rem] py-[2.2rem] bg-gray-light h-[43rem] relative overflow-hidden rounded-bl-full  '>
      ...
      <p className='text-[#252849] text-md my-[0.6rem] font-sans' >Different Platform?<Link href="#" underline="none" sx={{color:"#273444"}} className='px-[0.4rem] font-sans text-[#273444] font-bold underline'>
          {'Contact Us'}
        </Link> </p>
