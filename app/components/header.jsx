...
const Header = () => {
  return (
    <div>
      ...
      <Link href="/" underline="none" className='text-xl text-[#252849]  px-3 font-sans'>
          {'Home'}
        </Link>
        <Link href="services" underline="none" className='text-xl text-[#252849]   px-3 font-sans'>
          {'Services'}
        </Link>
        <Link href="about" underline="none" className='text-xl text-[#252849]   px-3 font-sans'>
          {'About'}
        </Link>
